...
import { GraphQLService } from '@cife-core/services/graph-ql.service';
import { map, Observable } from 'rxjs';
import { NodeStatus } from '@cife-shared/types/app/node-status.type';
import { HttpClient } from '@angular/common/http';
import { ConfigService } from '@cife-core/services/config.service';
