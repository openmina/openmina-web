...
import { Theme } from '@ocfe-shared/types/core/theme/theme.type';
...
import {
  ...
  SELECTED_CSS_PREFIX,
  SPECIAL_CSS_PREFIX,
  SUCCESS_CSS_PREFIX, ThemeCssCategory,
  WARN_CSS_PREFIX,
} from '@ocfe-shared/types/core/theme/theme-css-category.type';
...
const DARK_THEME: Theme = {
  ...
  categories: {
    ...
    special: {
      ...
      [`${SPECIAL_CSS_PREFIX}selected-alt-1-secondary`]: '#746493',
