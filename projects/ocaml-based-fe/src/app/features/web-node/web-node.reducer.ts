...
import { WebNodeSharedState, WebNodeState } from '@ocfe-web-node/web-node.state';

import * as fromLogs from '@ocfe-web-node/web-node-logs/web-node-logs.reducer';
import * as fromPeers from '@ocfe-web-node/web-node-peers/web-node-peers.reducer';
import * as fromWallet from '@ocfe-web-node/web-node-wallet/web-node-wallet.reducer';

import { WebNodeLogsAction, WebNodeLogsActions } from '@ocfe-web-node/web-node-logs/web-node-logs.actions';
import { WebNodePeersAction, WebNodePeersActions } from '@ocfe-web-node/web-node-peers/web-node-peers.actions';
import { WebNodeWalletAction, WebNodeWalletActions } from '@ocfe-web-node/web-node-wallet/web-node-wallet.actions';
import {
...
import { PEER_CONNECTED, PEER_DISCONNECTED } from '@ocfe-web-node/web-node.service';
