...
import { DashboardSplitsSetActivePeer } from '@ocfe-dashboard/splits/dashboard-splits.actions';
...
export class DashboardSplitsGraphComponent extends StoreDispatcher implements OnInit {
  ...
  private listenToPeersLinksSets(): void {
    this.select(selectDashboardSplitsPeersAndLinksAndSetsAndFetching, ({ peers, links, sets, fetching }) => {
