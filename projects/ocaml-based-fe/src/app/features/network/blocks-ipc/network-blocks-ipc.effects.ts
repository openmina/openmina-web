...
import { NetworkBlocksIpcService } from '@ocfe-network/blocks-ipc/network-blocks-ipc.service';
...
export class NetworkBlocksIpcEffects extends MinaOcamlBaseEffect<NetworkBlocksIpcActions> {
