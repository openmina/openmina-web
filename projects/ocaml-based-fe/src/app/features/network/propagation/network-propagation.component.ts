...
export class NetworkPropagationComponent implements OnInit, AfterViewInit {
  ...
  private render() {
    ...
    const shortestPaths: { [p: string]: any } = calculateShortestPaths(initialData, baseNode);
  ...
  private getLevel(shortestPaths: { [p: string]: any }, n: any): number {
