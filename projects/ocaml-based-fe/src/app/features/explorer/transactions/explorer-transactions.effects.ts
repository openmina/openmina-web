...
import { ExplorerTransactionsService } from '@ocfe-explorer/transactions/explorer-transactions.service';
import {
...
} from '@ocfe-explorer/transactions/explorer-transactions.actions';
...
export class ExplorerTransactionsEffects extends MinaOcamlBaseEffect<ExplorerTransactionsActions> {
