...
const getNetworkMessages = (store: Store<MinaState>) => ocfeStateSliceAsPromise<NetworkMessagesState>(store, condition, 'network', 'messages');
...
describe('NETWORK MESSAGES FOOTER', () => {
  ...
  it('set 5m interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsFiveMinutesAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 30m interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsThirtyMinutesAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 1h interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsOneHourAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 12h interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsTwelveHoursAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 1d interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsOneDayAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 2d interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsTwoDaysAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 7d interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsSevenDaysAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
  ...
  it('set 30d interval in interval picker component', () => {
    ...
    cy.get('mina-network-messages-table-footer button:last-child')
      ...
      .invoke('val')
      .then((value: string) => {
        expect(value).to.equal(secondsThirtyDaysAgo.toString());
      })
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(5)')
      .should('have.value', yearNow)
      .get('.cdk-overlay-container mina-interval-select .container div:nth-child(3) form input:nth-child(6)')
